...
@Entity @Table(name="pool_user_device") public interface PoolUserDeviceEntity {
 @Id UUID id(); @Column(name="tenant_id") UUID tenantId(); @Column(name="user_id") UUID userId(); @Column(name="device_token_hash") String deviceTokenHash();
