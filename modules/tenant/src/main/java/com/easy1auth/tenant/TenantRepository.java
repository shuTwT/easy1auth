...
class TenantRepository {
    ...
    TenantRepository(JSqlClient sql) {
        this.sql = sql;
    }
    ...
    Optional<TenantEntity> lockActiveTenant(UUID tenantId) {
    ...
    Optional<TenantEntity> lockOrdinaryTenant(UUID tenantId) {
    ...
    /** 按 ID 查询普通租户（不加锁）。 */
    Optional<TenantEntity> findOrdinaryTenant(UUID tenantId) {
    ...
    Optional<TenantMembershipEntity> activeAdministratorMembership(UUID tenantId) {
    ...
    Optional<TenantMembershipEntity> lockActiveAdministratorMembership(UUID tenantId) {
    ...
    /** 加行级锁查询某账号在指定租户的成员关系。 */
    Optional<TenantMembershipEntity> lockMembership(UUID tenantId, UUID accountId) {
    ...
    TenantEntity createOrdinaryTenant(String name, long packageId) {
    ...
    /** 更新普通租户的名称与绑定套餐。 */
    void updateOrdinaryTenant(UUID tenantId, String name, long packageId) {
    ...
    void createActiveAdministratorMembership(UUID tenantId, UUID accountId, String role) {
        Instant now = Instant.now();
    ...
    /** 停用（suspended）指定成员关系。 */
    void suspendMembership(UUID membershipId) {
    ...
    void suspendAllMemberships(UUID tenantId) {
    ...
    void activateAdministratorMembership(UUID membershipId, String role) {
    ...
    void promoteActiveMembership(UUID membershipId, String role) {
