...
@Entity @Table(name="federation_provider") public interface FederationProviderEntity extends BaseEntity, BaseTenantEntity {
 String name(); String issuer(); @Column(name="client_id") String clientId();
