...
@Entity @Table(name="external_identity_binding") public interface ExternalIdentityBindingEntity extends BaseEntity, BaseTenantEntity {
 @Column(name="provider_id") UUID providerId(); @Column(name="pool_user_id") UUID poolUserId();
