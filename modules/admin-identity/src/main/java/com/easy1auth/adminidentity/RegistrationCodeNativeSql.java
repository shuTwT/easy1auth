 ...
 */
@Component
final class RegistrationCodeNativeSql {
    private final JdbcClient db;

    RegistrationCodeNativeSql(JdbcClient db) {
        this.db = db;
    }

    boolean consume(String email, String hash) {
