...
public class AuthController {
    ...
    public record LoginResponse(String status,String token,String refreshToken,LoginUser user,List<?> tenants,String challengeToken,List<String> methods,Integer expiresIn) {
        static LoginResponse success(String token,String refresh,LoginUser user,List<?> tenants){return new LoginResponse("success",token,refresh,user,tenants,null,null,null);}
        static LoginResponse mfa(String challenge,int expires){return new LoginResponse("mfa_required",null,null,null,List.of(),challenge,List.of("totp"),expires);}
    }
}
