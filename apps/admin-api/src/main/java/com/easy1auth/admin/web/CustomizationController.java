...
public class CustomizationController {
    ...
    @TenantManagementPermission(value = ManagementPermissionCode.BRAND_READ, boundary = TenantDataBoundary.TENANT_ALL)
    ...
    @TenantManagementPermission(value = ManagementPermissionCode.BRAND_UPDATE, boundary = TenantDataBoundary.TENANT_ALL)
    ...
    @TenantManagementPermission(value = ManagementPermissionCode.LOGIN_STYLE_READ, boundary = TenantDataBoundary.TENANT_ALL)
    @GetMapping("/api/login-style")
    ApiResponse<?> style(HttpServletRequest r) {
        return ApiResponse.ok(service.style(c(r).tenantId()));
    }

    @TenantManagementPermission(value = ManagementPermissionCode.LOGIN_STYLE_UPDATE, boundary = TenantDataBoundary.TENANT_ALL)
    ...
    @TenantManagementPermission(value = ManagementPermissionCode.CUSTOM_DOMAIN_LIST, boundary = TenantDataBoundary.TENANT_ALL)
    @GetMapping("/api/custom-domains")
    ApiResponse<?> domains(HttpServletRequest r) {
        return ApiResponse.ok(service.domains(c(r).tenantId()));
    }

    @TenantManagementPermission(value = ManagementPermissionCode.CUSTOM_DOMAIN_CREATE, boundary = TenantDataBoundary.TENANT_ALL)
    ...
    @TenantManagementPermission(value = ManagementPermissionCode.CUSTOM_DOMAIN_VERIFY, boundary = TenantDataBoundary.TENANT_ALL)
    ...
    @TenantManagementPermission(value = ManagementPermissionCode.CUSTOM_DOMAIN_SSL, boundary = TenantDataBoundary.TENANT_ALL)
    ...
    @TenantManagementPermission(value = ManagementPermissionCode.CUSTOM_DOMAIN_DELETE, boundary = TenantDataBoundary.TENANT_ALL)
    ...
    @TenantManagementPermission(value = ManagementPermissionCode.MESSAGE_TEMPLATE_LIST, boundary = TenantDataBoundary.TENANT_ALL)
    ...
    @TenantManagementPermission(value = ManagementPermissionCode.MESSAGE_TEMPLATE_CREATE, boundary = TenantDataBoundary.TENANT_ALL)
    ...
    @TenantManagementPermission(value = ManagementPermissionCode.MESSAGE_TEMPLATE_UPDATE, boundary = TenantDataBoundary.TENANT_ALL)
    ...
    @TenantManagementPermission(value = ManagementPermissionCode.MESSAGE_TEMPLATE_DELETE, boundary = TenantDataBoundary.TENANT_ALL)
    ...
    @TenantManagementPermission(value = ManagementPermissionCode.MESSAGE_TEMPLATE_INIT, boundary = TenantDataBoundary.TENANT_ALL)
    ...
    private static TenantContext c(HttpServletRequest r) {
        return (TenantContext) Objects.requireNonNull(r.getAttribute(TenantContextFilter.ATTRIBUTE));
    }
