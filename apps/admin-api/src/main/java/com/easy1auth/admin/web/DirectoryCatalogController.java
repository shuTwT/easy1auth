...
public class DirectoryCatalogController {
    ...
    ApiResponse<?> groups(@RequestParam(defaultValue = "1") int page, @RequestParam(defaultValue = "10") int pageSize,
        ...
        var x = catalog.groups(TenantContextHolder.requireTenantId(), page, pageSize, name, type, parentId);
    ...
    ApiResponse<?> createGroup(@RequestBody DirectoryCatalogService.GroupInput in) {
        return ApiResponse.ok(catalog.createGroup(TenantContextHolder.requireTenantId(), in), "用户组创建成功");
    }
    ...
    ApiResponse<?> updateGroup(@PathVariable UUID id, @RequestBody DirectoryCatalogService.GroupInput in) {
        return ApiResponse.ok(catalog.updateGroup(TenantContextHolder.requireTenantId(), id, in), "用户组更新成功");
    }
    ...
    ApiResponse<Void> deleteGroup(@PathVariable UUID id) {
        catalog.deleteGroup(TenantContextHolder.requireTenantId(), id);
    ...
    ApiResponse<?> groupMembers(@PathVariable UUID id) {
        return ApiResponse.ok(catalog.groupMembers(TenantContextHolder.requireTenantId(), id));
    }
    ...
    ApiResponse<Void> addMembers(@PathVariable UUID id, @RequestBody UserIds in) {
        catalog.addMembers(TenantContextHolder.requireTenantId(), id, in.userIds());
    ...
    ApiResponse<Void> removeMembers(@PathVariable UUID id, @RequestBody UserIds in) {
        catalog.removeMembers(TenantContextHolder.requireTenantId(), id, in.userIds());
    ...
    ApiResponse<Void> addAdmins(@PathVariable UUID id, @RequestBody UserIds in) {
        catalog.addAdmins(TenantContextHolder.requireTenantId(), id, in.userIds());
    ...
    ApiResponse<Void> removeAdmins(@PathVariable UUID id, @RequestBody UserIds in) {
        catalog.removeAdmins(TenantContextHolder.requireTenantId(), id, in.userIds());
    ...
    ApiResponse<?> positions(@RequestParam(defaultValue = "1") int page, @RequestParam(defaultValue = "10") int pageSize,
        ...
        var x = catalog.positions(TenantContextHolder.requireTenantId(), page, pageSize, name, code, departmentId, level);
        return ApiResponse.ok(PageData.of(x.data(), x.page(), x.pageSize(), x.total()));
    }
    ...
    ApiResponse<?> positionStats() {
        return ApiResponse.ok(catalog.positionStats(TenantContextHolder.requireTenantId()));
    }
    ...
    ApiResponse<?> position(@PathVariable UUID id) {
        return ApiResponse.ok(catalog.position(TenantContextHolder.requireTenantId(), id));
    }
    ...
    ApiResponse<?> createPosition(@RequestBody DirectoryCatalogService.PositionInput in) {
        return ApiResponse.ok(catalog.createPosition(TenantContextHolder.requireTenantId(), in), "岗位创建成功");
    }
    ...
    ApiResponse<?> updatePosition(@PathVariable UUID id, @RequestBody DirectoryCatalogService.PositionInput in) {
        return ApiResponse.ok(catalog.updatePosition(TenantContextHolder.requireTenantId(), id, in), "岗位更新成功");
    }
    ...
    ApiResponse<Void> deletePosition(@PathVariable UUID id) {
        catalog.deletePosition(TenantContextHolder.requireTenantId(), id);
