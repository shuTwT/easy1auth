package com.easy1auth.framework.tenant.persistence.interceptor;
...
import com.easy1auth.framework.tenant.persistence.model.BaseTenantEntityDraft;
import com.easy1auth.framework.tenant.persistence.model.BaseTenantEntityProps;
import com.easy1auth.framework.tenant.error.ErrorCodeConstants;
...
public final class TenantEntityDraftInterceptor
     ...
     */
    @Override
    public void beforeSave(@NonNull BaseTenantEntityDraft draft, @Nullable BaseTenantEntity original) {
