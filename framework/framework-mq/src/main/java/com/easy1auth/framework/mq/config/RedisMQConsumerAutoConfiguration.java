...
import com.easy1auth.framework.mq.job.RedisPendingMessageResendJob;
import com.easy1auth.framework.mq.stream.AbstractRedisStreamMessageListener;
...
public class RedisMQConsumerAutoConfiguration {
    ...
    private static final Logger log = LoggerFactory.getLogger(RedisMQConsumerAutoConfiguration.class);
